...
public class CameraFade : MonoBehaviour {   
    ...
    public bool m_isColorColor = false;
    ...
    {   
		...
		if( Time.time > instance.m_FadeDelay )
		{
			...
			{			
				...
				if (Mathf.Abs(instance.m_CurrentScreenOverlayColor.grayscale - instance.m_TargetScreenOverlayColor.grayscale) < Mathf.Abs(instance.m_DeltaColor.grayscale) * Time.deltaTime)
				{
                ...
                //else if (instance.m_CurrentScreenOverlayColor != instance.m_TargetScreenOverlayColor) {
				...
				else
				{
					...
					SetScreenOverlayColor(Color.Lerp(instance.m_CurrentScreenOverlayColor, instance.m_TargetScreenOverlayColor, Time.deltaTime));
				}
			}
		}
